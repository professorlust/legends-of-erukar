...
class EquipTests(unittest.TestCase):
    def test_equip_weapon(self):
        ...
        self.assertEqual(Equip.equipped_right.format('Sword'), result)
    ...
    def test_equip_armor(self):
        ...
        self.assertEqual(Equip.equipped_chest.format('Plate Mail'), result)
    ...
    def test_equip_item(self):
        ...
        self.assertEqual(Equip.cannot_equip.format('Potion'), result)
