...
class Bunk(RoomModifier):
    ...
    def apply_to(self, room):
        ...
        deco.set_detailed_results('There is a bunk {bed_state} to the {location} which has some sort of smell to it.','You can smell {bed_smell} originating from a {bed_state} bunk to the {location} of the room.')
        room.add(deco)
