...
class IceBurst(Spell):
    ...
    TheyCastSpell = "{alias|lifeform} raises his hands and speaks in an ancient language. Before you can react, a blast of freezing air, shards of ice, and snow hits you!"
