...
class AcidBurst(Spell):
    ...
    TheyCastSpell = "{alias|lifeform} raises his hands and speaks in an ancient language. A billow of acid jettisons from his palms, and before you have a moment to respond it douses you completely!" 
