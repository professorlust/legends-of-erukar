...
class Equip(ActionCommand):
    ...
    equipped_chest = "'{0}' equipped as chest armor successfully"
    equipped_helm = "'{0}' equipped as helm successfully"
    equipped_gloves = "'{0}' equipped as gloves successfully"
    equipped_pants = "'{0}' equipped as pants successfully"
    equipped_boots = "'{0}' equipped as boots successfully"
    equipped_ring = "'{0}' equipped as ring successfully"
    equipped_amulet = "'{0}' equipped as amulet successfully"
    equipped_blessing = "'{0}' equipped as blessing successfully"
