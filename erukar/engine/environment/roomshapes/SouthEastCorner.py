...
class SouthEastCorner(Shape):
    def coordinates(room):
        x_i, y_i = Map.translate_coordinates_to_grid(room.coordinates)
        x_corner = x_i + SouthEastCorner.x_corner_mod(room)
        y_corner = y_i + SouthEastCorner.y_corner_mod(room)
    ...
    def center(room):
        x_i, y_i = Map.translate_coordinates_to_grid(room.coordinates)
        return (
            x_i + SouthEastCorner.x_corner_mod(room),
            y_i + SouthEastCorner.y_corner_mod(room)
        )
